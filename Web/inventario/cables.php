                                ...
                                foreach ($articulos as $articulo) {
                                    ...
                                    echo "<td class='text-center'>
                                            <div class='btn-group btn-group-sm' role='group'>
                                                ...
                                                <button type='button' data-id=" . htmlspecialchars($articulo['ID_Articulo']) . " data-categoria='cables' class='btn btn-outline-warning' id='botonModal' title='Editar' data-bs-toggle='modal' data-bs-target='#modalEditarArticulo'>
