<div class="content">
                                ...
                                foreach ($articulos as $articulo) {
                                    if ($articulo['activo'] != 0 || $_SESSION['usuario_INMASY']['rol'] == 1) {
                                        ...
                                        if ($articulo['disponibilidad'] == 0 && $articulo['activo'] != 0) {
                                            echo "<button type='button' data-id=" . htmlspecialchars($articulo['ID_Articulo']) . " data-categoria='electronica' class='btn btn-outline-success' id='botonModal' title='Pedir' data-bs-toggle='modal' data-bs-target='#modalPedirArticulo'>
    ...
    <?php include_once './Web/inventario/electronicaEditar.php' ?>
